...
const labels = {
  en: { home: 'Home', diagram: 'Diagram', upload: 'Upload', chatgpt: 'AI Chat', about: 'About', en: 'English', da: 'Dansk' },
  da: { home: 'Hjem', diagram: 'Diagram', upload: 'Upload', chatgpt: 'AI Chat', about: 'Om', en: 'Engelsk', da: 'Dansk' }
}
